...
public:
    ...
    int longestIncreasingPath(vector<vector<int>>& matrix) { 
        ...
        while (!q.empty()) {
            ...
            // Topological ordering gives us the dependency structure. Kahn's level-by-level processing computes the longest dependency depth, which is the longest path in this DAG.
